...
const cardMonitor = {
  ...
  drop(props, monitor, component) {
    ...
    props.moveObject(item.fromPosition, props.position);
 ...
 */
function cardDNDProps(connect, monitor) {
  return {
...
export default DropTarget(Types.CARD, cardMonitor, cardDNDProps)(ChessSquare);
